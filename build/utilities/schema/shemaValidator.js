...
exports.schemaValidationLogin = exports.schemaValidationRegister = void 0;
const { checkSchema, validationResult } = require('express-validator');
exports.schemaValidationRegister = checkSchema({
    password: {
        isLength: {
...
exports.schemaValidationLogin = checkSchema({
    password: {
        isLength: {
            errorMessage: 'Password should be at least 7 chars long',
            // Multiple options would be expressed as an array
...
//# sourceMappingURL=shemaValidator.js.map